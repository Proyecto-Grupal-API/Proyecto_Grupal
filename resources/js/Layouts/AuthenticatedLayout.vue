            ...
            <nav class="border-b border-gray-100 bg-white">
                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink :href="route('modulo6.dashboard')" :active="route().current('modulo6.*')">
                                    Comunidad
                                </NavLink>
                            </div>
                        </div>
                            ...
                            <div class="relative ms-3">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <DropdownLink :href="route('nfc-cards.index')"> Tarjetas NFC </DropdownLink>
                ...
                <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown }" class="sm:hidden">
                    <div class="space-y-1 pb-3 pt-2">
                        ...
                        <ResponsiveNavLink :href="route('modulo6.dashboard')" :active="route().current('modulo6.*')">
                            Comunidad
                        </ResponsiveNavLink>
                    </div>
                    ...
                    <div class="border-t border-gray-200 pb-1 pt-4">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <ResponsiveNavLink :href="route('nfc-cards.index')"> Tarjetas NFC </ResponsiveNavLink>
