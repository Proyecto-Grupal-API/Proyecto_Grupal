...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <div>
                <p class="text-xs font-bold uppercase tracking-[0.22em] text-[#0284C7]">Campus Virtual</p>
                <h2 class="mt-1 text-2xl font-bold tracking-tight text-[#00338D]">Inicio</h2>
            </div>
        </template>

        <div class="min-h-[calc(100vh-9rem)] bg-[#F5F8FC] px-4 py-8 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-7xl">
                <section class="rounded-2xl bg-[#00338D] p-7 text-white shadow-xl shadow-[#00338D]/10 sm:p-10">
                    <p class="text-sm text-blue-100">Bienvenido de nuevo</p>
                    <h1 class="mt-2 text-3xl font-bold sm:text-4xl">Tu experiencia universitaria, en un solo lugar.</h1>
                ...
                <div class="mt-6 grid gap-5 md:grid-cols-2">
                    <a :href="route('modulo6.dashboard')" class="group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:border-[#0284C7]">
                        <span class="text-xs font-bold uppercase tracking-[0.18em] text-[#0284C7]">Módulo 6</span>
                        <h2 class="mt-3 text-xl font-bold text-[#00338D]">Comunidad</h2>
                        <p class="mt-2 text-sm leading-6 text-slate-500">Organizaciones, eventos, becas y participación estudiantil.</p>
                        <span class="mt-6 inline-block text-sm font-bold text-[#00338D] group-hover:text-[#0284C7]">Entrar a Comunidad →</span>
                    </a>
